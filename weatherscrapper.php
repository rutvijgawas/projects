<?php
    ...
    if ($_GET['city']) {
       ...
       $urlContents=file_get_contents("http://api.openweathermap.org/data/2.5/weather?q=".$_GET['city']."&appid=44e2b5469a3b956cdc8c6c0d7d550862");
     ...
     if($weatherArray['cod']==200)
     {
      ...
      $weathertemp=intval($weatherArray['main']['temp']-273);
      
      $weather.="and the temperature is ".$weathertemp."&deg;c<br>";
